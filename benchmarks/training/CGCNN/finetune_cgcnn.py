...
class FineTune(object):
    ...
    def train(self):
        ...
        epoch_array = np.linspace(0, self.config['epochs'], self.config['epochs'] + 1)
        self.model = model
        #plt.plot(epoch_array, loss_train)
        #plt.plot(epoch_array, loss_val)
        #plt.xlabel('epoch')
        #plt.ylabel('MSE')
...
if __name__ == "__main__":
    ...
    print("Creating FineTune object...", flush = True)
